...
export const testFullHierarchy = action({
  ...
  handler: async (ctx) => {
    ...
    console.log("Expected: Uses fluxProUltra (quality) despite fast preference\n");
    ...
    console.log("Setting: type='image-to-image', preference='quality', no model");
    ...
    console.log("Expected: Auto-detects image-to-image, uses default preference\n");
    ...
    tests.push({
      ...
      input: { image_url: "provided", model: "none", type: "none", preference: "none" },
