...
function AppsTable({
  ...
  const generateCoverImage = useAction(api.features.appGeneration.coverImage.generateAndSaveCoverImage);
  const removeCoverVideo = useMutation(api.data.apps.removeCoverVideo);
