...
import { FluxTextToImageParams, FluxModel, FalTextToImageResponse } from "../types";
...
export async function generateFluxTextToImage(
  ...
  const safetySettings = configureSafetySettings(model, enable_safety_checker, safety_tolerance);
